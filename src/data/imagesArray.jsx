const images = [
  `${process.env.PUBLIC_URL}/images/FredeluxAgency/Fredelux_agency.jpg`,
  `${process.env.PUBLIC_URL}/images/GameBoy/gameboy.jpg`,
  `${process.env.PUBLIC_URL}/images/FindMeAMovie/FindMeAMovie.jpg`,
  ...
  `${process.env.PUBLIC_URL}/images/TheSuperQuiz/TheSuperQuizPoster.jpg`,
];
